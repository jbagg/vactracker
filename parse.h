...
public:
	bool parseCmd(QObject *ref, QString cmd);

protected:
	virtual bool parseObjects(QObject *ref, QString type, QString id, QString tail);
	virtual bool parseAction(QObject *ref, QString id, QString value, qint32 n);
